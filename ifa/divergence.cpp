/* Generated by Cython 0.20.1post0 (Debian 0.20.1+git90-g0e6e38e-1ubuntu2) on Sun Jan  4 10:13:04 2015 */
 ...
 */
  ...
  if (!(likely(__Pyx_TypeTest(__pyx_v_p, __pyx_ptype_3ifa_12distribution_Distribution)))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "ifa/divergence.pyx":49
 * cpdef jsd(p, double p_weight, q, double q_weight):
 *     return c_jsd((<Distribution?>p).thisptr, p_weight,
 *                  (<Distribution?>q).thisptr, q_weight)             # <<<<<<<<<<<<<<
 */
  if (!(likely(__Pyx_TypeTest(__pyx_v_q, __pyx_ptype_3ifa_12distribution_Distribution)))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *                  (<Distribution?>q).thisptr, q_weight)
 */
  __pyx_t_1 = PyFloat_FromDouble(ifa::jsd(((struct __pyx_obj_3ifa_12distribution_Distribution *)__pyx_v_p)->thisptr, __pyx_v_p_weight, ((struct __pyx_obj_3ifa_12distribution_Distribution *)__pyx_v_q)->thisptr, __pyx_v_q_weight)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pw_3ifa_10divergence_1jsd(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("jsd (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_p_weight)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("jsd", 1, 4, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_q)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("jsd", 1, 4, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_q_weight)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("jsd", 1, 4, 4, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "jsd") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_p = values[0];
    __pyx_v_p_weight = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_p_weight == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_q = values[2];
    __pyx_v_q_weight = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_q_weight == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("jsd", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("ifa.divergence.jsd", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_3ifa_10divergence_jsd(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_p, double __pyx_v_p_weight, PyObject *__pyx_v_q, double __pyx_v_q_weight) {
  ...
  __Pyx_RefNannySetupContext("jsd", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_3ifa_10divergence_jsd(__pyx_v_p, __pyx_v_p_weight, __pyx_v_q, __pyx_v_q_weight, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("jsd"), (PyCFunction)__pyx_pw_3ifa_10divergence_1jsd, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  __pyx_ptype_3ifa_12distribution_Distribution = __Pyx_ImportType("ifa.distribution", "Distribution", sizeof(struct __pyx_obj_3ifa_12distribution_Distribution), 1); if (unlikely(!__pyx_ptype_3ifa_12distribution_Distribution)) {__pyx_filename = __pyx_f[3]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Variable import code ---*/
  /*--- Function import code ---*/
  /*--- Execution code ---*/

  /* "ifa/divergence.pyx":24
 * 
 * import cython
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
